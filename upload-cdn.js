...
const { uploadDistToCdn, parseDeployDescription } = await import(
  join(root, '../anlan-base/shared/upload-cdn-core.js')
)
...
await uploadDistToCdn({
  ...
  description: parseDeployDescription(process.argv.slice(2)),
})
